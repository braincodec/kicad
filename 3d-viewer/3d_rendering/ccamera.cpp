...
void CCAMERA::rebuildProjection()
{
    ...
    // Consider that we can render double the lenght multiplied by the 2/sqrt(2)
    //
...
void CCAMERA::updateFrustum()
{
    ...
    m_right = glm::normalize( SFVEC3F( m_viewMatrixInverse * glm::vec4( SFVEC3F( 1.0, 0.0, 0.0 ), 0.0 ) ) );
