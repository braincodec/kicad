...
DIALOG_MODEDIT_OPTIONS_BASE::DIALOG_MODEDIT_OPTIONS_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	m_TextModSizeVTitle = new wxStaticText( this, wxID_ANY, _("&Vertical text size"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_TextModSizeHTitle = new wxStaticText( this, wxID_ANY, _("&Horizontal text size"), wxDefaultPosition, wxDefaultSize, 0 );
